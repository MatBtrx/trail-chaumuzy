...
const TYPOS = {
  impact:    { label: "Sport - impact condensé",  display: "'Bebas Neue','Barlow Condensed',sans-serif", text: "'Barlow',sans-serif",       tr: "uppercase", wt: 400, tk: ".005em", accent: "#E8631C" },
  modern:    { label: "Moderne et épuré",           display: "'Space Grotesk',sans-serif",                 text: "'Public Sans',sans-serif",  tr: "none",      wt: 600, tk: "-.01em", accent: "#E8631C" },
  synapse:   { label: "Synapse Sport (teal/violet)", display: "'Quicksand',sans-serif",                   text: "'Mulish',sans-serif",       tr: "none",      wt: 700, tk: "-.01em", accent: "#00838b" },
...
const THEMES = {
  "#E8631C": { gold: "#D6A23E" },              // Orange + or (déclinaison deck)
  "#D6A23E": { gold: "#E6B34A" },              // Or chaud
  "#6E3FA3": { gold: "#CBA23A", champ: "#6E3FA3" }, // Champagne (violet + or)
  "#E6FF1A": { gold: "#CBD24A" },              // Fluo + lime-or
  "#00838b": { gold: "#C77DD6", champ: "#9600a6" }, // Synapse teal + violet
  "#9600a6": { gold: "#36B5B0", champ: "#00838b" }  // Synapse violet + teal
};
...
function PulseDivider() {
  return (
    <div className="wrap" style={{ padding: "10px 28px 2px" }}>
      <Reveal><PulseLine /></Reveal>
    </div>
  );
}
...
function safeOnLight(hex) {
  ...
  let guard = 0;
  while (contrast(lum(r, g, b)) < 2.85 && guard++ < 40) { r = Math.round(r * 0.88); g = Math.round(g * 0.88); b = Math.round(b * 0.88); }
